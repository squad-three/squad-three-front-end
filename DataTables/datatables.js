 ...
 *   https://datatables.net/download/#bs/dt-1.10.15/e-1.6.3/se-1.2.2
 *
 * Included libraries:
 *   DataTables 1.10.15, Editor 1.6.3, Select 1.2.2
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"bs/dt-1.10.15/e-1.6.3/se-1.2.2",
...
Editor.prototype._ajax = function ( data, success, error, submitParams )
{
	...
	var opts = {
		...
		complete: [ function ( xhr, text ) {
			...
			that._event( 'postSubmit', [json, submitParams, action, xhr] );
